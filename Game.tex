...
\title{Unified Tabletop Role Playing Game}
...
\begin{document}
    ...
    \chapter{Copyright}
    \section*{License}
        The text in this work is licensed under the Creative Commons Attribution-ShareAlike 4.0 International License.
    ...
    \chapter{Introduction}
        Unified Tabletop Role Playing Game is a game for having adventures in a sci-fi world where the rules don't bog down game play but there is still depth and meaningful choices in character creation and progression.
    ...
    \chapter{Playing the game}
        ...
        \section{General Rules}
            ...
            \subsection{Timing}
                ...
                Every Action takes an amount of time. At the start of an encounter each character involved rolls a d4 then adds the Action Time of the Action and any additional modifiers. The character with the lowest number goes first, then in order from lowest to highest.

                After a character takes their Action they then roll a d4 and add the Action time with any additional modifiers. This number is added to the turn number that they took the Action in.
        ...
        \section{Combat Encounters}
            ...
            \subsection{Time Units}
                Each Time Unit in a Combat Encounter is 0.2 seconds, so 5 would be one second and 25 would be 5 seconds.
        ...
        \section{Social Encounters}
            ...
            \subsection{Time Units}
                Each Time Unit in a Social Encounter is 0.2 seconds, so 5 would be one second and 25 would be 5 seconds.
        ...
        \section{Investigation}
            ...
            \subsection{Time Units}
                Each Time Unit in a Investigation depends on what is trying to be done and the scale at what it is being done at. Searching for a location could have each time unit being a minute or looking for the killer could have each time unit being 0.2 minutes.
    ...
    \chapter{Character Creation and Progression}
        \section{Creating Characters}
            ...
            \subsection{Speed}
                Each human Character has a base speed of $1ms^{-1}$, $60m$ per minute, $3.6kmh^{-1}$.
    ...
    \chapter{Game Master Advice}
        ...
        \section{Bestiary}
            %Ortri -Norse -Triceratops warriors -Heat melee weapons, ballistic weapons +1,-1,0
            %Screlf -Egyptian Architecture, rigid society -Scarab theocracy -Beam melee weapons, Laser weapons 0,+1,-1
            %Gnobot -Gothic Architecture -Monarchy -Rail Weapons +1,0,-1
            %Drrat -Rats -Scavengers -Any weapons -1,0,+1
